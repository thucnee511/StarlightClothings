...
import starlight.model.user.GoogleUserDAO;
...
public class GoogleLogin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String accessToken = googleUserDao.getToken(code);
            GoogleUserDTO googleUser = googleUserDao.getUserInfo(accessToken);
            request.setAttribute("googleUser", googleUser);
            url = SUCCESS;
        } catch (Exception e) {
            log("Error at google login servlet: " + e.toString());
        } finally {
